package beakjoon.archive.algorithm.greedy;
/*
문제
- neighbor 블로그를 운영하는 일우는 매일 아침 풀고 싶은 문제를 미리 정해놓고 글을 올린다. 
  ...
  1~2번 문제를 파란색, 3번을 빨간색, 4번을 파란색, 5번을 빨간색, 6~7번을 파란색, 
  8번을 빨간색으로 칠하는 작업을 순서대로 수행하면 6번의 작업을 거쳐야 한다. 
...
public class Baekjoon20365 {
  public static void main(String[] agrs) throws IOException {
    ...
    StringTokenizer str = new StringTokenizer(s, "R");
    StringTokenizer stb = new StringTokenizer(s, "B");

    red += str.countTokens();
    blue += stb.countTokens();
