package beakjoon.archive.algorithm.mathematics;
/*
문제
...
public class Baekjoon13458 {
  public static void main(String[] agrs) throws IOException {
    ...
    int main = Integer.parseInt(st.nextToken());    // 총 감독관 감시 가능 인원
    int sub = Integer.parseInt(st.nextToken());     // 부 감독관 감시 가능 인원
