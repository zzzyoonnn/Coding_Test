...
- 숭실대학교 정보과학관은 숭실대입구역으로부터 멀리 떨어져 있는 대신, 
  ...
  다행히 아슬아슬하게 막차가 끊기지 않은 상황인데, 
  구체적으로 A분 뒤에 숭실대별관앞 정류소에 집으로 가는 마지막 버스가 도착하고, 
...
public class Baekjoon28113 {
  public static void main(String[] agrs) throws IOException {
    ...
    int n = Integer.parseInt(st.nextToken());   // 지하철가지 가는 시간
    int a = Integer.parseInt(st.nextToken());   // a분 뒤 버스 도착
    int b = Integer.parseInt(st.nextToken());   // b분 뒤 지하철 도착
